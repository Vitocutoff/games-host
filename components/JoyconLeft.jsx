...
export default function JoyconLeft({ onChangeColor, colors }) {
  ...
  return (
    <div
      style={{ background: `linear-gradient(to bottom right, ${colors.left.from}, ${colors.left.to})`, transition: "background 0.6s ease",}}
      className="relative h-full w-[11%] rounded-l-[5.5rem] overflow-hidden"
    >

      {/* TASTO MENO */}
      <div
        className="absolute top-[5%] right-[10%] w-[20%] h-[1%]
      ...
      {/* LEVETTA ANALOGICA */}
      <div
        className="absolute top-[22%] left-1/2 -translate-x-1/2 w-[58%]
      ...
      <div
        ...
        className={`absolute bottom-[22%] left-[58%] w-[18%] aspect-square
                    bg-gradient-to-b from-[#1b1b1b] to-[#0a0a0a]
                    rounded-md cursor-pointer
                    shadow-[inset_1px_1px_3px_rgba(255,255,255,0.15),_0_2px_3px_rgba(0,0,0,0.6)]
      ...
      >
        <div
          className="absolute bottom-[8%] left-[50%] -translate-x-1/2
                     p-2 text-xs z-50 bg-black/50 text-white rounded-md
